    ...
    return (
        <div>
            ...
            <div className="w-full h-[1000px] md:[500px] lg:h-[400px] relative">
                <div className="absolute border p-7 bg-base-100 rounded-2xl -top-28 flex flex-col md:flex-row items-start justify-start gap-7 w-10/12 md:w-8/12 mx-auto inset-x-0">
                    <div className="w-full">
